<?php
    ...
    if(isset($_POST["act"])){
        ...
        switch ($act){
            case "store":
                ...
                $prodi = $_POST["txPRODI"];
                $email = $_POST["txEMAIL"];
                $sql = "INSERT INTO tbmahasiswa(nim, nama, alamat, prodi, jeniskelamin) VALUES('$nim', '$nama', '$prodi', '$email');";
    ...
    if(isset($_GET["aksi"])){
        ...
        switch($aksi) {
            case "new":
                $jdpage = "Tambah";
                $pg = "datamahasiswanew.php";
                break;
            case "edit":
                $jdpage = "Ubah";
                $pg = "datamahasiswaedit.php";
                break;
            case "del":
                $jdpage = "Hapus";
                $pg = "datamahasiswadel.php";
                break;
            default:
                $jdpage = "List";
                $pg = "datamahasiswalist.php";
