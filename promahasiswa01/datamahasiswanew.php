...
<form method="POST" action="datamahasiswa.php">
    ...
    <div class="form-floating mb-3">
        <input type="email" name="txNIM" class="form-control" id="floatingInput" placeholder="NIM">
        <label for="floatingInput">NIM</label>
    </div>
    <div class="form-floating mb-3">
        <input type="text" name="txALAMAT" class="form-control" id="floatingInput" placeholder="Prodi">
        <label for="floatingInput">Prodi</label>
    </div>
    <div class="form-floating mb-3">
        <input type="email" name="txEmail" class="form-control" id="floatingInput" placeholder="Email">
